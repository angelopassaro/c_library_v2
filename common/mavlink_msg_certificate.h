...
/**
 * @brief Get field seq_number from certificate message
 *
 * @return  Certificate sequent number
 */
static inline uint8_t mavlink_msg_certificate_get_seq_number(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field device_name from certificate message
 *
 * @return  Name of machine
 */
static inline uint16_t mavlink_msg_certificate_get_device_name(const mavlink_message_t* msg, char *device_name)
{
    return _MAV_RETURN_char_array(msg, device_name, 20,  10);
}

/**
 * @brief Get field subject from certificate message
 *
 * @return  Name of certification authority
 */
static inline uint16_t mavlink_msg_certificate_get_subject(const mavlink_message_t* msg, char *subject)
{
    return _MAV_RETURN_char_array(msg, subject, 20,  30);
}

/**
 * @brief Get field issuer from certificate message
 *
 * @return  Name of issuer
 */
static inline uint16_t mavlink_msg_certificate_get_issuer(const mavlink_message_t* msg, char *issuer)
{
 ...
 */
static inline float mavlink_msg_certificate_get_start_time(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field end_time from certificate message
 *
 * @return  Certified end of validity
 */
static inline float mavlink_msg_certificate_get_end_time(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    certificate->start_time = mavlink_msg_certificate_get_start_time(msg);
    certificate->end_time = mavlink_msg_certificate_get_end_time(msg);
    certificate->seq_number = mavlink_msg_certificate_get_seq_number(msg);
    certificate->device_id = mavlink_msg_certificate_get_device_id(msg);
    mavlink_msg_certificate_get_device_name(msg, certificate->device_name);
