...
#define MAVLINK_KEY_EXCHANGE_PENDING 1
#define MAVLINK_KEY_EXCHANGE_COMPLETE 2

#define MAVLINK_SIGNATURE_BLOCK_LEN 13
#define MAVLINK_CERTIFICATE_LEN 97

#define MAVLINK_MAX_PACKET_LEN (MAVLINK_MAX_PAYLOAD_LEN + MAVLINK_NUM_NON_PAYLOAD_BYTES + MAVLINK_SIGNATURE_BLOCK_LEN + MAVLINK_CERTIFICATE_LEN) ///< Maximum packet length
 ...
 */
    ...
    MAVPACKED(
        typedef struct __mavlink_message {
            ...
            uint8_t certificate[MAVLINK_CERTIFICATE_LEN];
        })
    mavlink_message_t;
...
#define MAVLINK_IFLAG_CERT 0x02
